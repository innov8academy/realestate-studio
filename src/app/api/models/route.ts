...
const KIE_MODELS: ProviderModel[] = [
  ...
  },
  {
    id: "kling-3.0/video",
    name: "Kling 3.0",
    description: "Kling 3.0 video generation with start/end frame support via Kie.ai.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
  ...
  },
  {
    id: "kling/v2-1-pro",
    name: "Kling 2.1 Pro",
    description: "Kling 2.1 Pro image-to-video with start/end frame support via Kie.ai.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/kling-2-1",
  },
  {
  ...
  },
  {
    ...
    description: "Bytedance Seedance 1.5 Pro video generation with start/end frame support via Kie.ai.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/seedance",
  },
  {
    id: "bytedance/v1-lite-image-to-video",
    name: "Seedance 1.0 Lite",
    description: "Bytedance Seedance 1.0 Lite image-to-video with end frame support via Kie.ai.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/seedance",
  },
  {
    ...
    name: "Hailuo 02 Pro",
    description: "MiniMax Hailuo 02 Pro image-to-video with start/end frame support via Kie.ai.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/hailuo",
  },
  {
    id: "hailuo/02-image-to-video-standard",
    name: "Hailuo 02 Standard",
    description: "MiniMax Hailuo 02 Standard image-to-video with start/end frame support via Kie.ai.",
    provider: "kie",
    capabilities: ["image-to-video"],
    coverImage: undefined,
    pageUrl: "https://kie.ai/hailuo",
